...
FluScrollablePage{
    ...
    function newTab(){
        tab_view.appendTab("qrc:/qt/qml/start/res/image/favicon.ico","Document "+tab_view.count(),com_page,colors[Math.floor(Math.random() * 8)].dark)
    }
    ...
    function newTab(){
        tab_view.appendTab("qrc:/qt/qml/start/res/image/favicon.ico","Document 1",com_page,argument)
    }
}
'
    }
